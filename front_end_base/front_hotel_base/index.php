...
<title>Início | Hotel Admin</title>
...
<section class="hero p-4 p-lg-5 mb-4">
  <span class="badge rounded-pill mb-3">EXERCÍCIO DE AULA</span>
  <h1 class="display-6 fw-bold">Sistema de Gestão de Hotel</h1>
  <p class="lead mb-0">Front-end base para ser integrado ao backend PHP desenvolvido pelos alunos.</p>
</section>
